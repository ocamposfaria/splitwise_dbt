...
UNION ALL SELECT '2024-01' AS `month` 
UNION ALL SELECT '2024-02' AS `month` 
UNION ALL SELECT '2024-03' AS `month` 
UNION ALL SELECT '2024-04' AS `month` 
UNION ALL SELECT '2024-05' AS `month` 
UNION ALL SELECT '2024-06' AS `month` 
UNION ALL SELECT '2024-07' AS `month` 
UNION ALL SELECT '2024-08' AS `month` 
UNION ALL SELECT '2024-09' AS `month` 
UNION ALL SELECT '2024-10' AS `month` 
UNION ALL SELECT '2024-11' AS `month` 
UNION ALL SELECT '2024-12' AS `month`